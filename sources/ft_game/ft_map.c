...
/*   Updated: 2024/04/04 21:22:21 by tlassere         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_print_ray(t_data *data)
{
	...
	dist = ft_dda(data, (t_fvec){(float)(data->player.x + SCALE / 2) / SCALE, (float)(data->player.y + SCALE / 2) / SCALE}, data->player.rotat);
	pos = 0;
	while (pos < 10000)
	{
